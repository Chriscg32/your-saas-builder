...
export default function BusinessAdvisor() {
  ...
  // Typed state for results
  const [results, setResults] = useState<BusinessInsights | null>(null);
  ...
  const generateStrategicInsights = (
    ...
    const selected = [...STRATEGY_CATEGORIES]
      .sort(() => 0.5 - Math.random())
      .slice(0, 3);

    const strategiesMap: Record<string, BusinessInsights['strategies'][number]> = {
      "Market Disruption": {
        title: "Market Disruption Strategy",
        description:
          "Identify and exploit inefficiencies in the current market structure.",
        recommendations: [
      ...
      "Vertical Integration": {
        ...
        description:
          "Control multiple stages of your industry's value chain to increase efficiency and quality.",
        recommendations: [
      ...
      "First Principles Thinking": {
        ...
        description:
          "Break down complex problems into their fundamental elements and rebuild from scratch.",
        recommendations: [
      ...
      "Ambitious Goal Setting": {
        ...
        description:
          "Set seemingly impossible targets to drive innovation and breakthrough thinking.",
        recommendations: [
      ...
      "Capital Allocation": {
        ...
        description:
          "Prioritize resources toward high-leverage opportunities with exponential return potential.",
        recommendations: [
      ...
      "Talent Acquisition": {
        ...
        description:
          "Build teams of exceptional individuals who can execute at extraordinary levels.",
        recommendations: [
      ...
      "Risk Management": {
        ...
        description:
          "Take significant but carefully calculated risks to achieve outsized returns.",
        recommendations: [
    ...
    return {
      ...
      opportunityScore,
      strategies: selected.map((cat) => strategiesMap[cat]),
      executionPlan: {
    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      ...
      {results && (
        <div className="max-w-3xl mx-auto mt-8 bg-white rounded-lg shadow p-6">
          {/* Render results with proper typing */}
